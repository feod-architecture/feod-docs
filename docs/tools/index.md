...
| --- | --- | --- |
| [FEOD Analyzer](./feod-analyzer.md) | Строить граф FEOD-сущностей, находить нарушения импортов и public API, экспортировать HTML/JSON отчёт. | Готовый CLI-артефакт, сценарии запуска, конфигурация и ограничения. |
